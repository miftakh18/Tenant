...
<div class="card shadow">
    ...
    <div class="card-body">
        ...
        <?php if (!empty($bulan)) : ?>
            <a id="pdf_masuk" href="<?= BASEURL ?>/barang_keluar/cetak/bulan/<?= $bulan . '/' . $tahun ?>" target="_blank" class="btn btn-sm btn-outline-danger"> <i class="fas fa-file-pdf me-2"></i>PDF</a>

        <?php else : ?>
            <a id="pdf_masuk" href="<?= BASEURL ?>/barang_keluar/cetak/tanggal/<?= $dari . '/' . $sampai ?>" target="_blank" class="btn btn-sm btn-outline-danger"> <i class="fas fa-file-pdf me-2"></i>PDF</a>
        <?php endif ?>
        <table class="kepala">
            <tr>
                <td class="kepala-m ">
                ...
                <td>
                    <table width="100%">
                        <tr>
                            <td align="center">
                                <hr class="hr">
                                <h3> <b> LAPORAN BARANG KELUAR</b></h3>
                                <hr class="hr">
                            </td>
                        </tr>
            ...
            <tr>
                <td>
                    ...
                    <table class="data2" width="100%" align="center">
                        ...
                        $no = 1;
                        $jumlah = 0;
                        $keluar = $data['data_keluar']->getTable($dari, $sampai, $bulan, $tahun);
