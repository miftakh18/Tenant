    ...
    <div class="vh-100  ">
        <div class="container-fluid d-flex justify-content-center align-items-center h-100 p-auto  ">
            <div class="col-12 col-sm-6 col-lg-3 ">
                <div class="card text-center shadow-lg h-50  "
                    style="border-radius: 25px 25px  !important; height:450px !important">
                    <div class="card-header pt-5" style="border-radius: 25px 25px 0 0  !important;">
                        ...
                        <div class=" fs-5 pt-3 fw-bolder ">
                            <span class="border-bottom"
                                style="color:rgba(48, 93, 145, 0.96) !important;border-bottom:2px solid rgb(34, 174, 95) !important ;letter-spacing: 10px !important;">TENANT
                                MMC</span>
                        </div>
                    </div>
                    <div class="card-body ">
                        <form id="frmlogin">
                            <div class="row">
                                ...
                                <div class="col-lg-12 px-5 pt-3">
                                    <div class="form-group has-icon-left ">
                                        <label for="first-name-icon "
                                            style="width:100%;text-align:left">Username</label>
                                        <div class="position-relative border-default">
                                            <input type="text" class="form-control"
                                                style=" border: 1px solid var(--bs-default-text-color-gelap) !important;border-radius: 50px 50px  !important;"
                                ...
                                <div class="col-lg-12 px-5 pb-2 ">
                                    <div class="form-group has-icon-left">
                                        <label for="password-id-icon"
                                            style="width:100%;text-align:left">password</label>
                                ...
                                <div class="col-lg-12 px-5 pb-3 d-flex justify-content-center">
                                    <button type="submit" class="btn bg-default btn-block shadow text-white "
                                        style="border-radius: 50px 50px  !important;">LOGIN</button>
                                </div>
                            </div>
                        </form>
                    </div>
